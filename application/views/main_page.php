                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-aqua">
                                ...
                                <a href="<?php echo site_url('item'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- Total Stok -->
                        <div class="col-lg-3 col-xs-6">
                            <div class="small-box bg-green">
                                ...
                                <a href="<?php echo site_url('model'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- Stok Dalam Proses -->
                        <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-xs-6">
                            <div class="small-box bg-aqua">
                                ...
                                <a href="<?php echo site_url('proses'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- Stok Pada Rosso -->
                        <div class="col-lg-2 col-xs-6">
                            <div class="small-box bg-green">
                                ...
                                <a href="<?php echo site_url('rosso'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- Stok Pada Balikan -->
                        <div class="col-lg-2 col-xs-6">
                            <div class="small-box bg-red">
                                ...
                                <a href="<?php echo site_url('balikan'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- Stok Pada Oven -->
                        <div class="col-lg-2 col-xs-6">
                            <div class="small-box bg-yellow">
                                ...
                                <a href="<?php echo site_url('oven'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- Stok Pada Packing -->
                        <div class="col-lg-2 col-xs-6">
                            <div class="small-box bg-purple">
                                ...
                                <a href="<?php echo site_url('packing'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
